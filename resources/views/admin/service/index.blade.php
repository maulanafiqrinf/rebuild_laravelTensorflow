                            ...
                            <tbody>
                                @foreach ($services as $index => $service)
                                    <tr>
                                        ...
                                        <td>{{ $service->nama }}</td>
                                        <td>
                                            <img src="{{ $service->image }}" alt="Ikon" style="max-width: 100px;">
                                        </td>
                                        <td>{{ $service->category }}</td>
                                        <td>
                                            <!-- Edit Button -->
                                            <button class="btn btn-sm btn-info edit-btn" data-bs-toggle="modal"
                                                data-bs-target="#editModal" data-id="{{ $service->id }}"
                                                data-name="{{ $service->nama }}" data-image="{{ $service->image }}" data-detail="{{ $service->detail }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">Tambah service</h5>
                ...
                <div class="modal-body">
                    <form id="addserviceForm" action="{{ route('services.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama service:</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editserviceForm" action="" method="POST">
                        ...
                        @method('PUT')
                        <div class="mb-3">
                            <label for="editName" class="form-label">Nama service:</label>
